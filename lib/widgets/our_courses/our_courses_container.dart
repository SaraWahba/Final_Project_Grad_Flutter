...
class OurCoursesContainer extends StatelessWidget {
  const OurCoursesContainer({super.key, required this.image, required this.text, required this.numberLessons, required this.numberStudent, required this.textDescription, required this.namePerson, required this.rate, required this.price, required this.numberStart});
  final String image ;
  final String text ;
