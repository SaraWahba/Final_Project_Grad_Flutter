...
class InstructorViewDetails extends StatefulWidget {
  ...
  @override
  State<InstructorViewDetails> createState() => _InstructorViewDetailsState();
}

class _InstructorViewDetailsState extends State<InstructorViewDetails> {
